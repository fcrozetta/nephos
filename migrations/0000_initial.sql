...
CREATE TABLE app_instances (
    ...
    catalog_kind TEXT NOT NULL CHECK (catalog_kind = 'App'),
...
CREATE TABLE service_instances (
    id TEXT PRIMARY KEY,
    slug TEXT NOT NULL UNIQUE,
    catalog_kind TEXT NOT NULL CHECK (catalog_kind = 'Service'),
    catalog_name TEXT NOT NULL,
    catalog_version TEXT,
    catalog_source_id TEXT NOT NULL,
    catalog_source_path TEXT NOT NULL,
...
CREATE TABLE bindings (
    id TEXT PRIMARY KEY,
    app_instance_id TEXT NOT NULL REFERENCES app_instances(id),
...
CREATE TABLE status_snapshots (
    ...
    lifecycle TEXT CHECK (lifecycle IN ('running', 'stopped', 'removed')),
    reconciliation TEXT,
    reason TEXT,
    message TEXT,
...
CREATE INDEX idx_reconciliation_requests_state_created_at
