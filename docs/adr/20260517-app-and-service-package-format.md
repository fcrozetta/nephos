...
Route hostnames are generated by Nephos from route intent and configured ingress root domains.

Do not put full hostnames into App manifests as the primary route model.
