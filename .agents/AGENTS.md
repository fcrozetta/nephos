...
Before making architectural changes, read the current architecture context, including `.agents/context/nephos-api-resource-model.md` and `.agents/context/nephos-naming-and-metadata.md`, plus `docs/adr/`.
