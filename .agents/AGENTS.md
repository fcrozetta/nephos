...
Before making architectural changes, read the current architecture context, including `.agents/context/nephos-api-resource-model.md`, `.agents/context/nephos-database-state.md`, `.agents/context/nephos-catalog-loading.md`, and `.agents/context/nephos-naming-and-metadata.md`, plus `docs/adr/`.
